...
export const Portfolio = () : JSX.Element => (
    <section className="portfolio">
        ...
        <ul>
            ...
            <li>
                <img alt="Northpoint Santos" src={imgNPSantos}/>
            ...
            <li>
                ...
                <div className="details">
                    ...
                    <p>Newsletters produced regularly using Mailchimp.</p>
            ...
            <li>
                ...
                <p>I have hosted it through AWS Amplify using AWS Simple Notification Service for the contact form.</p>
                <div className="clear"/>
            </li>
        </ul>
    </section>
